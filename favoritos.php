...
$videosNuevosQ = $db->query("SELECT v.idVideo, v.nombreVideo, v.fechaSubida, v.cantVistas, v.usuario, v.imagen, v.duracion FROM video v, usuariofavorito uv WHERE v.idVideo = uv.idVideo AND uv.idUsuario = $idUsuario ORDER BY v.fechaSubida DESC");
...
<html>
    <head>
        ...
        <title><?=NOMBRE_APP?> – Favoritos, Tu Portal De Videos Favoritos</title>
    ...
    ?>
	  ...
	  <div class="site-output">
        ...
        <div id="all-output" class="col-md-10">
        	...
        	<h1 class="new-video-title"><i class="fa fa-star"></i> Mis Favoritos</h1>
            <div class="row">
            <?php
            if(isset($videosn))
            {
            ...
            {
                echo '<h2>No tienes ningun video agregado a favoritos, explora nuestros videos</h2>';
            }
            ?>
